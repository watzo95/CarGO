...
public class Tour {
    ...
    public ArrayList<Destinacija> tour = new ArrayList<Destinacija>();
    ...
    public Tour(Tour someTour){
        this.tour = (ArrayList<Destinacija>) someTour.tour.clone();
    }
...
//        setDestination(tourPos1, dest2);
    ...
    public ArrayList<Destinacija> getAllDest() {
        return tour;
    }

    public Destinacija getDestination(int tourPosition) {
        return tour.get(tourPosition);
    }

    // sets a Destination to certain position in the tour
    public void setDestination(int tourPosition, Destinacija destination) {
    ...
    public double getDistance(){
        if (distance == 0) {
            ...
            for (int Index=0; Index < tourSize(); Index++) {
                ...
                Destinacija fromDestination = getDestination(Index);
                // Destination we're travelling to
                Destinacija destinationDestination;
    ...
    public boolean containsDestination(Destinacija destination){
